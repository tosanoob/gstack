...
**ask_user tool Q1 — include ALL of these:**
...
**ask_user tool Q2 — present the full proposal with SAFE/RISK breakdown:**
...
Each drill-down is one focused ask_user tool. After the user decides, re-check coherence with the rest of the system.
...
**ask_user tool Q-final — show summary and confirm:**
